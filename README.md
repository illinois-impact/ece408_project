...
| ---------------- | ------------ | -----------------------------------------------------------------------------------------| ---------------------------------------------------------------------------------------- |
| Linux            | amd64        | [URL](https://github.com/rai-project/rai/releases/download/v0.2.23/linux-amd64.tar.gz)   | [URL](https://github.com/rai-project/rai/releases/download/v0.2.27/windows-amd64.tar.gz) |
| OSX/Darwin       | amd64        | [URL](https://github.com/rai-project/rai/releases/download/v0.2.23/darwin-amd64.tar.gz)  | [URL](https://github.com/rai-project/rai/releases/download/v0.2.27/windows-amd64.tar.gz) |
