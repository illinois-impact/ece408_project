...
# since your convolution will not have a bias term, we tell MXNet not to use a bias
# with the 'no_bias' argument, so it is directly comparable to your implementation.
